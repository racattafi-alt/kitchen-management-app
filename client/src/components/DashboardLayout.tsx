...
import { LayoutDashboard, LogOut, PanelLeft, Users, Package, Utensils, ChefHat, BarChart3, Calendar, DollarSign, AlertTriangle, Shield, FolderOpen, Bot, ShoppingCart, Building2, History, TrendingUp, Crown, Globe, Upload, Wrench } from "lucide-react";
...
const menuItems = [
  ...
  { icon: History, label: "Storico Ordini", path: "/order-history" },
...
const adminMenuItems = [
  ...
  { icon: Wrench, label: "Debug Ricette", path: "/recipe-debug" },
];
